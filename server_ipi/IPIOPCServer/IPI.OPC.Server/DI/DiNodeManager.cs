...
namespace Opc.Ua.Di
{
    ...
    /// </summary>
    public class DINodeManager : NodeManager
    {
            ...
            base(server)
        {
            ...
            namespaceUris.Add(global::Opc.Ua.Di.Namespaces.OpcUaDi);
            namespaceUris.Add(global::Opc.Ua.Di.Namespaces.OpcUaDi + "/Instance");
        ...
        /// </summary>
        protected override string PredefinedNodesResourcePath => "IPI.OpcUaServer.DI.GeneratedCode.Opc.Ua.Di.PredefinedNodes.uanodes";
        #endregion
    }
}
